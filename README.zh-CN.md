...
LocaleEmulatorPlus 是原 [Locale Emulator](https://github.com/xupefei/Locale-Emulator) 的 GUI 与启动器部分的维护分支。原项目 README 已保留为
...
原 Locale Emulator 主要面向 x86，并且依赖较旧的构建环境。这个分支保留原有用户工作流，同时让代码可以使用
现代本地工具链构建，并补充 x64 启动支持。
