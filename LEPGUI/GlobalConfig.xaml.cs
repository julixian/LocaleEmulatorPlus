...
namespace LEPGUI
{
    ...
    public partial class GlobalConfig
    {
        ...
        private readonly List<LEPProfile> _profiles = new List<LEPProfile>();
        ...
        public GlobalConfig()
        {
            ...
            //Profiles.
            _profiles = LEPConfig.GetProfiles().ToList();
        ...
        private void bSaveGlobalSetting_Click(object sender, RoutedEventArgs e)
        {
            ...
            LEPConfig.SaveGlobalConfigFile(_profiles.ToArray());
        }
